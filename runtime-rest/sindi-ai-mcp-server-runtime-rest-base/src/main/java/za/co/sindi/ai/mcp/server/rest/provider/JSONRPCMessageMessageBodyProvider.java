...
public class JSONRPCMessageMessageBodyProvider implements MessageBodyReader<JSONRPCMessage> {
	...
	public JSONRPCMessage readFrom(Class<JSONRPCMessage> type, Type genericType, Annotation[] annotations,
		...
		// TODO Auto-generated method stub
		return MCPSchema.deserializeJSONRPCMessage(IOUtils.toString(entityStream));
	}
}
